...
export function applyBoundsPadding(
  ...
  return [[paddedMinLat, paddedMinLon], [paddedMaxLat, paddedMaxLon]];
}
 ...
 */
export function calculateGeometryCenter(geometry: Array<{ lat: number; lon: number }>): { lat: number; lon: number } | null {
