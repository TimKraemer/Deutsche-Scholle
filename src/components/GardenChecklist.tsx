...
export default function GardenChecklist({ garden }: GardenChecklistProps) {
  ...
  return (
    <div className="mt-6 pt-6 border-t border-scholle-border">
      <h3 className="text-xl font-bold text-scholle-text mb-4">
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-start gap-3 mb-1">
                <div className="flex-shrink-0 mt-1 text-scholle-green">
                  {step.icon}
                </div>
                <div className="flex-1">
                  <h4 className="font-semibold text-scholle-text mb-1">
                    {step.title}
                  </h4>
                  ...
                  {step.location && (
                    <p className="text-xs text-scholle-text-light mt-1 italic">
                      {step.location}
                    </p>
                  )}
                  {step.advisors && (
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-blue-800 mb-2">
              <strong>Vereinshaus:</strong> Limbergerstr. 71, 49080 Osnabrück<br />
              <strong>Tel.:</strong> 0541 / 84840<br />
              <strong>E-Mail:</strong>{' '}
              <a href="mailto:info@deutsche-scholle-os.de" className="underline hover:text-blue-900">
