...
export default function CookieConsentHint({
  service,
  services,
  feature,
  onOpenCookieConsent,
}: CookieConsentHintProps) {
      ...
      >
        ...
        {requiredServices.length > 1 && (
          <p className="text-scholle-text-light mb-3 text-base">
            Die 3D-Luftbildansicht benötigt sowohl OpenStreetMap-Daten für die Gartenumrisse als
            auch Google Maps für die Satellitenbilder.
          </p>
        )}
